//
//  vk-uniform-buffer.hpp
//  new-engine
//
//  Created by Kenneth Esdaile on 3/5/24.
//

#ifndef kege_graphics_vk_uniform_buffer_hpp
#define kege_graphics_vk_uniform_buffer_hpp
...
namespace kege{namespace vk{
     ...
     */
    class UniformBuffer : public kege::UniformBuffer
    {
    public:
         ...
         */
        const vk::UniformBuffer* vulkan()const;
         ...
         */
        UniformBuffer( vk::Device* device );
...
#endif /* kege_graphics_vk_uniform_buffer_hpp */
