//
//  vk-vertex-buffer.hpp
//  new-engine
//
//  Created by Kenneth Esdaile on 3/5/24.
//

#ifndef kege_graphics_vk_vertex_buffer_hpp
#define kege_graphics_vk_vertex_buffer_hpp
...
namespace kege{namespace vk{
     ...
     */
    class VertexBuffer : public kege::VertexBuffer
    {
    public:
         ...
         *
         * @param device The Vulkan graphics device.
        ...
        /**
         * @brief Bind this vertex-buffer to the given command buffer.
         *
         ...
         */
        const vk::VertexBuffer* vulkan()const;
...
#endif /* kege_graphics_vk_vertex_buffer_hpp */
